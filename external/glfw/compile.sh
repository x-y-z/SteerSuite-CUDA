...
# MODIFIED FOR STEERSUITE:  solaris expects "-pthreads" 
# instead of "-pthread", even though it is the same functionality.
if [ "$OPERATING_SYSTEM" = "solaris" ]; then
  CFLAGS_THREAD="-pthreads"
else
