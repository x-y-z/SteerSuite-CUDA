...
bool SimulationEngine::_simulateOneStep()
{
	...
	agentUpdateTime += (min*60+sec)*1000+msec;
	...
	min = system_time2.wMinute - system_time1.wMinute;
	sec = system_time2.wSecond - system_time1.wSecond;
	msec = system_time2.wMilliseconds - system_time1.wMilliseconds;
